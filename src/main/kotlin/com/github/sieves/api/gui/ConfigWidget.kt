...
interface ConfigWidget<T : ApiTile<T>> : BaseWidget<T> {
    ...
    private fun renderSideButtons(stack: PoseStack, mouseX: Double, mouseY: Double) {
        renderSideButton(stack, mouseX, mouseY, ApiConfig.Side.Front, 24, 39)
        renderSideButton(stack, mouseX, mouseY, ApiConfig.Side.Left, 12, 39)
        renderSideButton(stack, mouseX, mouseY, ApiConfig.Side.Right, 36, 39)
        renderSideButton(stack, mouseX, mouseY, ApiConfig.Side.Back, 36, 51)
        renderSideButton(stack, mouseX, mouseY, ApiConfig.Side.Top, 24, 27)
        renderSideButton(stack, mouseX, mouseY, ApiConfig.Side.Bottom, 24, 51)
    }
    ...
    private fun renderSideButton(
        stack: PoseStack, mouseX: Double, mouseY: Double, side: ApiConfig.Side, x: Int, y: Int
    ) {
        ...
        if (current != ApiConfig.SideConfig.None)
    ...
    override fun postRender(stack: PoseStack, mouseX: Double, mouseY: Double) {
        ...
        renderButtonToolTip(
            stack, mouseX, mouseY, ApiConfig.Side.Front, 24, 39
        )
        renderButtonToolTip(
            stack, mouseX, mouseY, ApiConfig.Side.Left, 12, 39
        )
        renderButtonToolTip(
            stack, mouseX, mouseY, ApiConfig.Side.Right, 36, 39
        )
        renderButtonToolTip(
            stack, mouseX, mouseY, ApiConfig.Side.Back, 36, 51
        )
        renderButtonToolTip(
            stack, mouseX, mouseY, ApiConfig.Side.Top, 24, 27
        )
        renderButtonToolTip(
            stack, mouseX, mouseY, ApiConfig.Side.Bottom, 24, 51
        )
