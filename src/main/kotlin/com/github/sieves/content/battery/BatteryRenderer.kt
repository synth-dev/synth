...
import com.github.sieves.content.api.ApiRenderer
...
class BatteryRenderer : ApiRenderer<BatteryTile>() {
    private val texture = ResourceLocation("minecraft", "block/redstone_block")
    private var time = 0f

    override fun render(
        pBlockEntity: BatteryTile,
        pPartialTick: Float,
        stack: PoseStack,
    ...
    private fun drawBeams(stack: PoseStack, bufferSource: MultiBufferSource, tile: BatteryTile) {
...
//                )
    ...
    private fun drawPower(stack: PoseStack, bufferSource: MultiBufferSource, tile: BatteryTile) {
        ...
        val scale = (tile.getStoredPower() / tile.getTotalPower().toFloat())
    ...
    override fun shouldRenderOffScreen(pBlockEntity: BatteryTile): Boolean {
        return true
    }
    ...
    override fun shouldRender(pBlockEntity: BatteryTile, pCameraPos: Vec3): Boolean {
        return true
    }
}