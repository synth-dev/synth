 ...
 */
class OutputTile(blockPos: BlockPos, blockState: BlockState) : ReactorTile<OutputTile>(Registry.Tiles.Output, blockPos, blockState) {
    private var tick = 0
...
//        if (front.`is`(Blocks.Battery) && !blockState.getValue(OutputBlock.Piped)) {//If there's item import in front of us, update our state
//        }
    }
